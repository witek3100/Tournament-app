...
Simple web app for managing football tournaments created using Django and PostgreSQL. You can check how current version works here [https://tournament--manager.herokuapp.com/](HERE)
## About project
